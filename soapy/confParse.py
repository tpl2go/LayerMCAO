...
class Configurator(object):
    ...
    def loadSimParams(self):
        """
        Load sub-dictionaries in simConfiguration into appropriate dictionary attributes
        Calls the other two initialization function --- readfile and calcParams
        """
